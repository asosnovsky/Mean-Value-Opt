...
\end{verbatim}
        ...
        \color{lightgray} \begin{verbatim}Matlab Time:  Elapsed time is 0.754263 seconds.

Us Time:  Elapsed time is 0.002505 seconds.
...
Matlab Time:  Elapsed time is 1.997342 seconds.
\end{verbatim} \color{black}
    
        \color{lightgray} \begin{verbatim}Undefined function 'optimizeSupreme' for input arguments of type 'double'.
