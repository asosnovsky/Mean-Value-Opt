...
\section{Methodology}
	...
	\subsection{The Selection Process}
		...
		\textbf{Reduction Method}\par\medskip
			...
			\end{tikzpicture}
		\end{center}
		We then iterate the two methods (addition and reduction), until a divergence in the portfolio indices and weights is observed through the Sharpe ratio (in practice it seems to take up to 3 itertation before a covergence is observed).
